...
export class CommandRunner {
  async run(command: ProjectCommand, approvalPolicy: ApprovalPolicy): Promise<CommandExecutionResult> {
...
function isCommandApproved(command: ProjectCommand, approvalPolicy: ApprovalPolicy): boolean {
